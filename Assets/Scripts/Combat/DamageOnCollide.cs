...
public class DamageOnCollide : MonoBehaviour {
	...
	private float cooldownTimer = float.PositiveInfinity;
	void OnCollisionStay(Collision collision){
		if(collision.gameObject.layer.Equals(LayerMask.NameToLayer("Player")) && cooldownTimer>cooldown && isActiveAndEnabled){
			cooldownTimer = 0f;
